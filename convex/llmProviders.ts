 ...
 * NOTE: Runtime failover in the daemon (packages/runtime) uses its own
 * {provider, model} pairs. Wire this into the runtime or keep in sync
 * manually when updating models.
 */
