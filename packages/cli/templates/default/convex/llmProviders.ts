 ...
 * NOTE: Runtime failover in packages/runtime/src/channels/http.ts
 * uses its own model resolution. Keep this list in sync with the
 * runtime when updating models.
 */
