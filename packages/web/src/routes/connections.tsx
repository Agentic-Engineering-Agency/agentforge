            ...
            <form onSubmit={handleSubmit}>
                ...
                <DialogContent>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="credentials" type="password" value={credentials} onChange={e => setCredentials(e.target.value)} placeholder={connection ? 'Enter new key to update' : 'Your secret key'} />
                    </div>
                    {testStatus && (
                ...
                <DialogFooter>
                    ...
                    <Button type="submit" className="bg-primary text-primary-foreground hover:bg-primary/80">{connection ? 'Save Changes' : 'Add Connection'}</Button>
                </DialogFooter>
            </form>
        </Dialog>
    );
